...
export function Inventory (){
  ...
  const ProcessSale = () => {
    const {cart, setCart, setTotal, setProducts, products, addToCart, editProduct, deleteProduct, lowInventoryProducts, total, } = useInventory();
          ...
          <tbody>
            {products.map((product) => (
              <tr key={product.id}>
                ...
                <td>{product.stock}</td>
                <td>
                  <button onClick={() => addToCart(product, cart, total)}>Agregar al Carrito</button>
                  <button onClick={() => editProduct(product, products, setProducts)}>Editar</button>
                  <button onClick={() => deleteProduct(product.id, products, setProducts)}>Eliminar</button>
                </td>
              </tr>
            ))}
          </tbody>
